...
private static Gson gson = new GsonBuilder().setPrettyPrinting().create();                      //make file clear and pretty organized rather than one line
...
categories = new ArrayList<>(Arrays.asList("Work","Personal","Shopping","General"));
		...
		while(true) {
         ...
         System.out.println("Not valid option");
			...
			public  void addtask (Scanner input) {
			   ...
			   public String getValidatedChoice(String prompt, List<String> options,Scanner input){                  //ensures user enters right values and not making error if the choice is noy valid
			        String choice;
			        while(true){
